...
rgb<-stack(system.file("extdata","evaluation/RGB/SJER_052.tif",package="NeonTreeEvaluation"))

#Path to dataset
xmls<-xml_parse(system.file("extdata","annotations/SJER_052.xml",package="NeonTreeEvaluation"))
...
```{r}
point_cloud<-readLAS(system.file("extdata","evaluation/LiDAR/SJER_052.laz",package="NeonTreeEvaluation"))
```
