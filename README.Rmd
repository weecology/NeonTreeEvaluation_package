...
There are currently 4 training data sites:
...
The training tiles are large (20GB) and are therefore not included in the R package. They are archived on Zenodo and can downloaded locally using the download_data() function
