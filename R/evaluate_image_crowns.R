...
#' @return If compute_PR is True, a data frame of precision-recall scores or each plot. If False, a dataframe with the intersection-over-union scores for each prediction.
#' @export
#'
